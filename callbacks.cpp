...
void callbacks::ConfigLoad1() {
	...
	g_config.load(&g_menu.main, XOR("1.configuration"));
...
void callbacks::ConfigLoad2() {
	g_aimbot.m_fake_latency = false;
	g_config.load(&g_menu.main, XOR("2.configuration"));
...
void callbacks::ConfigLoad3() {
	g_aimbot.m_fake_latency = false;
	g_config.load(&g_menu.main, XOR("3.configuration"));
...
void callbacks::ConfigLoad4() {
	g_aimbot.m_fake_latency = false;
	g_config.load(&g_menu.main, XOR("4.configuration"));
...
void callbacks::ConfigLoad5() {
	g_aimbot.m_fake_latency = false;
	g_config.load(&g_menu.main, XOR("5.configuration"));
...
void callbacks::ConfigLoad6() {
	g_aimbot.m_fake_latency = false;
	g_config.load(&g_menu.main, XOR("6.configuration"));
...
void callbacks::ConfigLoad() {
	...
	std::string file = tfm::format(XOR("%s.configuration"), config.data());
