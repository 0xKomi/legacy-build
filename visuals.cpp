...
void Visuals::StatusIndicators( ) {
	...
	if ( g_menu.main.visuals.indicators.get( 4 ) ) {
		Indicator_t ind{ };
		ind.color = ( g_input.GetKeyState( g_menu.main.aimbot.override.get( ) ) ) ? 0xff15c27b : Color( 255, 255, 255 );
...
void Visuals::ManualAntiAim() {
	...
	if (g_hvh.m_left) {
		render::rect(x - 50, y - 10, 1, 21, color);
		render::rect(x - 51, y - 10 + 1, 1, 19, color);
		render::rect(x - 52, y - 10 + 2, 1, 17, color);
		render::rect(x - 53, y - 10 + 3, 1, 15, color);
		render::rect(x - 54, y - 10 + 4, 1, 13, color);
		render::rect(x - 55, y - 10 + 5, 1, 11, color);
		render::rect(x - 56, y - 10 + 6, 1, 9, color);
		render::rect(x - 57, y - 10 + 7, 1, 7, color);
		render::rect(x - 58, y - 10 + 8, 1, 5, color);
		render::rect(x - 59, y - 10 + 9, 1, 3, color);
		render::rect(x - 60, y - 10 + 10, 1, 1, color);
	}
	else {
		render::rect(x - 50, y - 10, 1, 21, { 0, 0, 0, 125 });
		render::rect(x - 51, y - 10 + 1, 1, 19, { 0, 0, 0, 125 });
		render::rect(x - 52, y - 10 + 2, 1, 17, { 0, 0, 0, 125 });
		render::rect(x - 53, y - 10 + 3, 1, 15, { 0, 0, 0, 125 });
		render::rect(x - 54, y - 10 + 4, 1, 13, { 0, 0, 0, 125 });
		render::rect(x - 55, y - 10 + 5, 1, 11, { 0, 0, 0, 125 });
		render::rect(x - 56, y - 10 + 6, 1, 9, { 0, 0, 0, 125 });
		render::rect(x - 57, y - 10 + 7, 1, 7, { 0, 0, 0, 125 });
		render::rect(x - 58, y - 10 + 8, 1, 5, { 0, 0, 0, 125 });
		render::rect(x - 59, y - 10 + 9, 1, 3, { 0, 0, 0, 125 });
		render::rect(x - 60, y - 10 + 10, 1, 1, { 0, 0, 0, 125 });
	}
	...
	if (g_hvh.m_back) {
		render::rect(x - 10, y + 50, 21, 1, color);
		render::rect(x - 10 + 1, y + 51, 19, 1, color);
		render::rect(x - 10 + 2, y + 52, 17, 1, color);
		render::rect(x - 10 + 3, y + 53, 15, 1, color);
		render::rect(x - 10 + 4, y + 54, 13, 1, color);
		render::rect(x - 10 + 5, y + 55, 11, 1, color);
		render::rect(x - 10 + 6, y + 56, 9, 1, color);
		render::rect(x - 10 + 7, y + 57, 7, 1, color);
		render::rect(x - 10 + 8, y + 58, 5, 1, color);
		render::rect(x - 10 + 9, y + 59, 3, 1, color);
		render::rect(x - 10 + 10, y + 60, 1, 1, color);
	}
	else {
		render::rect(x - 10, y + 50, 21, 1, { 0, 0, 0, 125 });
		render::rect(x - 10 + 1, y + 51, 19, 1, { 0, 0, 0, 125 });
		render::rect(x - 10 + 2, y + 52, 17, 1, { 0, 0, 0, 125 });
		render::rect(x - 10 + 3, y + 53, 15, 1, { 0, 0, 0, 125 });
		render::rect(x - 10 + 4, y + 54, 13, 1, { 0, 0, 0, 125 });
		render::rect(x - 10 + 5, y + 55, 11, 1, { 0, 0, 0, 125 });
		render::rect(x - 10 + 6, y + 56, 9, 1, { 0, 0, 0, 125 });
		render::rect(x - 10 + 7, y + 57, 7, 1, { 0, 0, 0, 125 });
		render::rect(x - 10 + 8, y + 58, 5, 1, { 0, 0, 0, 125 });
		render::rect(x - 10 + 9, y + 59, 3, 1, { 0, 0, 0, 125 });
		render::rect(x - 10 + 10, y + 60, 1, 1, { 0, 0, 0, 125 });
	}
}
