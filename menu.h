...
public:
	void init() {
		...
		flags_enemy.AddShowCallback(callbacks::ENEMY_SELECTION);
...
public:
	void init() {
		...
		fake_latency_amt.setup("", XOR("fake_latency_amt"), 50.f, 10000.f, false, 0, 200.f, 50.f, XOR(L"ms"));
		...
		hitsounds.setup(XOR("hitsound"), XOR("hitsounds"), {XOR("off"), XOR("arena switch"), XOR("bell"), XOR("opera"), XOR("bameware"), XOR("dopium"), XOR("bubble"), XOR("cod"), XOR("fatality"), XOR("pop"), XOR("neverlose")});
