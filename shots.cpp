...
void Shots::OnHurt(IGameEvent* evt) {
	...
	if (g_menu.main.misc.hitmarker.get()) {
		...
		case 2: g_csgo.m_sound->EmitAmbientSound(XOR("training/bell_impact.wav"), 1.f); break;
		case 3: PlaySoundA(reinterpret_cast<char*>(opera), nullptr, SND_ASYNC | SND_MEMORY); break;
		case 4: PlaySoundA(reinterpret_cast<char*>(bameware), nullptr, SND_ASYNC | SND_MEMORY); break;
		case 5: PlaySoundA(reinterpret_cast<char*>(evilsound), nullptr, SND_ASYNC | SND_MEMORY); break;
		case 6: PlaySoundA(reinterpret_cast<char*>(bubble), nullptr, SND_ASYNC | SND_MEMORY); break;
		case 7: PlaySoundA(reinterpret_cast<char*>(cod), nullptr, SND_ASYNC | SND_MEMORY); break;
		case 8: PlaySoundA(reinterpret_cast<char*>(fatality), nullptr, SND_ASYNC | SND_MEMORY); break;
		case 9: PlaySoundA(reinterpret_cast<char*>(pop), nullptr, SND_ASYNC | SND_MEMORY); break;
		case 10: PlaySoundA(reinterpret_cast<char*>(neverlose), nullptr, SND_ASYNC | SND_MEMORY); break;
		}
	}
